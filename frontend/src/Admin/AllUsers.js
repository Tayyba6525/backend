...
console.log(uData)
  ...
  return (
      ...
      <div>
        <div className='w-25 px-3' style={{marginTop:150}}>
                    ...
                    <>
                        <tr key={user._id}>
                            ...
                            <td>
                                ...
                                <a onClick={()=>deleteUser(user._id)} className='btn btn-danger btn-sm w-100'><i class="fa fa-trash" aria-hidden="true">del</i></a>
                            </td>
                        </tr>
                    </>
                )
